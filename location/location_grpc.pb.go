...
func (c *locationServiceClient) Create(ctx context.Context, in *CreateLocationRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *locationServiceClient) Update(ctx context.Context, in *UpdateLocationRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *locationServiceClient) Delete(ctx context.Context, in *DeleteLocationRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedLocationServiceServer) Delete(context.Context, *DeleteLocationRequest) (*Response, error) {
