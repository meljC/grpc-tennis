...
var file_location_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x84, 0x01, 0x0a, 0x15, 0x43,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x24, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x12, 0x3f, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x1f, 0x2e, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x6f, 0x63, 0x61,
	...
	0x00, 0x12, 0x43, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x12, 0x1d, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x47, 0x65, 0x74,
	0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x12, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x1c, 0x2e,
...
var file_location_proto_goTypes = []interface{}{
	...
	(*GetLocationsRequest)(nil),   // 1: location.GetLocationsRequest
	...
	(*GetLocationsResponse)(nil),  // 5: location.GetLocationsResponse
	(*Response)(nil),              // 6: location.Response
}
var file_location_proto_depIdxs = []int32{
	0, // 0: location.LocationService.Create:input_type -> location.CreateLocationRequest
	1, // 1: location.LocationService.GetLocations:input_type -> location.GetLocationsRequest
	2, // 2: location.LocationService.Get:input_type -> location.GetLocationRequest
	3, // 3: location.LocationService.Update:input_type -> location.UpdateLocationRequest
	4, // 4: location.LocationService.Delete:input_type -> location.DeleteLocationRequest
	6, // 5: location.LocationService.Create:output_type -> location.Response
	6, // 6: location.LocationService.GetLocations:output_type -> location.Response
	6, // 7: location.LocationService.Get:output_type -> location.Response
	6, // 8: location.LocationService.Update:output_type -> location.Response
	6, // 9: location.LocationService.Delete:output_type -> location.Response
